            ...
            in
            {
              ...
              leechcore-plugins =
                final.callPackage "${memprocfs-derivation}/pkgs/by-name/le/leechcore-plugins/package.nix"
                  { };
              leechcore = final.callPackage "${memprocfs-derivation}/pkgs/by-name/le/leechcore/package.nix" { };
              memprocfs = final.callPackage "${memprocfs-derivation}/pkgs/by-name/me/memprocfs/package.nix" { };
